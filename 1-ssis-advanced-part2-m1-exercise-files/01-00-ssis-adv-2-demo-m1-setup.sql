-- 01-00-ssis-adv-2-demo-m1-setup.sql
...
INSERT INTO [stage].[stageProductCategory]
...
INSERT INTO [stage].[stageProductSubcategory]
...
INSERT INTO [stage].[stageProduct]
SELECT [ProductID]
      ,[Name]
      ,[ProductNumber]
      ,[MakeFlag]
...
from [dw].[DimProduct] inner join [AdventureWorks2012].[Production].[Product] s
on ProductAlternateKey = s.ProductNumber
